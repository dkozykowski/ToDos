...
import com.gmail.dkozykowski.viewmodel.TaskViewModel.LoadViewState.Success

class ActiveTasksFragment(private val updateIdlePage: (QueryTaskType) -> Unit) : PageFragment() {
